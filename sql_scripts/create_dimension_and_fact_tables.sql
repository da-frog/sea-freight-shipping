...
drop view if exists ScheduledVoyageDepartureDate;
go
...
go
drop view if exists ScheduledVoyageArrivalDate;
go
...
go
drop view if exists ScheduledShipmentDepartureDate;
go
...
go
drop view if exists ScheduledShipmentArrivalDate;
go
...
go
drop view if exists ActualVoyageDepartureDate;
go
...
go
drop view if exists ActualVoyageArrivalDate;
go
...
go
drop view if exists ActualShipmentDepartureDate;
go
...
go
drop view if exists ActualShipmentArrivalDate;
go
...
go
drop view if exists ShipmentOriginPort;
go
...
go
drop view if exists ShipmentDestinationPort;
go
...
go
drop view if exists ForeignTransporter;
go
...
go
drop view if exists ForeignConsolidator;
go
...
go
drop view if exists DomesticConsolidator;
go
...
go
drop view if exists DomesticTransporter;
go
