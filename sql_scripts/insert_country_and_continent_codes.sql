IF OBJECT_ID('dbo.CountryAndContinentCodes', 'U') IS NOT NULL
    TRUNCATE TABLE CountryAndContinentCodes;
GO
INSERT INTO CountryAndContinentCodes VALUES
    ...
    ('Oceania','OC','Disputed Territory','XX',NULL,NULL),
    ('Asia','AS','Iraq-Saudi Arabia Neutral Zone','XE',NULL,NULL),
    ('Asia','AS','United Nations Neutral Zone','XD',NULL,NULL),
    ('Asia','AS','Spratly Islands','XS',NULL,NULL);
