...
SELECT [Vehicle Key],
       ...
       [Vehicle Builder],
       CAST([Vehicle Fuel Usage per Day] * 400 AS decimal(18, 2))      [Vehicle Fuel Cost Per Day],
       CASE
